...
function InstitutionsMainPage({loggedIn, setLoggedIn, role}) {
  ...
  if ( institutions != null )
  {
    return (
      <div>
            ...
            {JSON.parse(localStorage.getItem('role'))[0].authority === "ROLE_COORDINATOR" && <NewSchool onAddSchool={addSchoolHandler} ></NewSchool>}
